...
namespace buki
{
	...
	struct Animation : public Component, public IDrawable, public IUpdatable
	{
		...
		{ 
			...
			{
				BUKI_PROP_NESTED_STRING_GROUPED(BUKI_FIELD_NESTED(Animation, "params", params, "defaultClip", defaultClip), "Playback"),
				BUKI_PROP_NESTED_BOOL_GROUPED(BUKI_FIELD_NESTED(Animation, "params", params, "playOnStart", playOnStart), "Playback"),
				BUKI_PROP_NESTED_FLOAT_GROUPED(BUKI_FIELD_NESTED(Animation, "params", params, "speed", speed), "Playback"),
				BUKI_PROP_NESTED_BOOL_GROUPED(BUKI_FIELD_NESTED(Animation, "params", params, "loop", loop), "Playback")
			};
